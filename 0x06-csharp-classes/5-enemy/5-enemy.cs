...
namespace Enemies
{
    ...
    public class Zombie
    {
       ...
       /// <summary>Constructor sets fields within Zombie class.</summary>
        ...
        /// <summary> Public overrride method defines behavior for ToString() from main</summary>
         public override string ToString() => $"Zombie Name: {name} / Total Health: {health}".Trim();
